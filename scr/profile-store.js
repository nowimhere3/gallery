...
export class ProfileStore {
  ...
  //
  // Vocabulary only: create/rename/delete a tag *definition*. Nothing here
  // touches any media item — assigning a tag to an item (item.userTags) is
  // a later milestone. Deleting a tag here does not need to reach into
  // userTags for the same reason: nothing writes to it yet.
